          ...
          tddGuidance: {
            ...
            properties: {
              generatedAt: {
                type: "string",
                format: "date-time",
                description: "When the TDD guidance was generated",
              },
              generatedBy: {
                type: "string",
                description: "Agent that generated the guidance",
              },
              forVersion: {
                type: "integer",
                minimum: 1,
                description: "Feature version this guidance is for",
              },
              suggestedTestFiles: {
                type: "object",
                properties: {
              ...
              frameworkHint: {
                type: "string",
                description: "Suggested test framework",
              },
            },
            additionalProperties: false,
            description: "Cached TDD guidance generated by AI",
          },
        },
        additionalProperties: false,
      },
